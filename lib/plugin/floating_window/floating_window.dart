...
import 'package:jarty/plugin/floating_window/channels.dart';
import 'package:jarty/plugin/floating_window/window_controller.dart';
import 'package:jarty/plugin/floating_window/window_controller_impl.dart';
...
class FloatingWindow {
  ...
  /// |-------|----------| -----------------------------------|
  /// | 0     | `String` | the value always is "floating_window".|
  ...
  static Future<WindowController> createWindow([String? arguments]) async {
    final windowId = await floatingWindowChannel.invokeMethod<int>(
      'createWindow',
      arguments,
    );
  ...
  static Future<List<int>> getAllSubWindowIds() async {
    final result = await floatingWindowChannel
